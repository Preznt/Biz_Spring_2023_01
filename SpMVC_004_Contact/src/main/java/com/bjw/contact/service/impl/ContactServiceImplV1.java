...
public class ContactServiceImplV1 implements ContactService{
	...
	/**
	 * 클래스 인스턴스변수 초기화 하기
	 * 인스턴스변수는 기본생성자에서 보통 기본값으로 초기화가 된다,
	 * null 또는 0 으로
	 * 
	 * 기본값이 null 로 선언된 객체를 통하여
	 * 무언가 실행을 하려고 하면 Null Pointer Exception 이 주로 발생한다
	 * 
	 * Null Pointer Exception 문제는 오래전부터 Java 개발자를 매우 괴롭혔다
	 */
//	private Random rnd = new Random(); // 이렇게 하지 말고
	private Random rnd; // 이렇게 선언만하고 아래 생성자에서 초기화 하기
...
//			System.out.println(num);
	...
	public Contact findById(String id) {
		 ...
		 */
		Contact myContact = new Contact("S0001","홍길동","bjw1403@gmail.com",33);
