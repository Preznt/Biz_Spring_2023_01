...
public interface BookDao {
	...
	/**
	 * 전체 데이터를 Select 하여
	 * 그 결과(table) 을 List<BookDto>형태로 변환하여 return 하겠다
	 * @return
	 */
...
//	@Insert("INSERT INTO tbl")
	...
	/**
	 * Insert, Update 는 Select, Delete 에 비해 상대적으로 SQL 코드가 다소 복잡하다
	 * SQL 코드가 복잡해 지면 Annotation 기반으로 Query 를 작성하기가 불편해 진다
	 * 
	 * 이럴때는 mybatis mapper 를 연동하여 SQL 을 처리할 수 있다
	 * 
