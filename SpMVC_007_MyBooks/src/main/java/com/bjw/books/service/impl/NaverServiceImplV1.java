...
import com.bjw.books.config.NaverSecret;
import com.bjw.books.models.BookDto;
import com.bjw.books.service.NaverBookService;
...
public class NaverServiceImplV1 implements NaverBookService{
	...
	public String queryURL(String search) {
		...
		String queyrURL = String.format("%2$s?query=%1$s",encodeText, NaverSecret.NAVER_BOOK_URL_JSON);
