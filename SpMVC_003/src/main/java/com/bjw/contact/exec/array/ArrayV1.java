...
public class ArrayV1 {
	...
	// main() 시작점 method
	// class 를 독립적으로 실행할 때 필요
	public static void main(String[] args) {
		
		int num1 = 0;
		// Java 에서는 문자열은 변수이면서, 객체다
		String str = "";
		 ...
		 */
		// 이렇게 만들면 기존에 있던 배열은 두고 20개가 저장될 또다른 저장소를 만들고 
		// nums1의 담긴 주소가 바뀌는 것
		nums1 = new int[20];
		nums1[0] = 200;
		// nums1 배열은 20개의 요소(item) 을 가지고 있다
		// 20 index 의 요소에 값을 저장하려고 하면 ArrayIndexOutOfBoundsException이 발생한다
		nums1[20] = 100;
		...
		/**
		 * 배열의 Index 의 최대값은 항상 전체 크기(length)의 -1 까지 이다
		 */
