...
import com.bjw.user.models.UserVO;
import com.bjw.user.service.UserService;
...
public class UserController {
	...
	public String join(UserVO user,Model model) {
		 ...
		 * java 코드에서는 변수값을 읽을 때는 객체.getter() 형식으로 
		 * 사용해야 한다.
		 */
	...
	public String detail(Model model) {
		 ...
		 * 
		 * model 은 선언과 생성이 동시에 일어난다
		 * 그래서 아래와 같은 addA.. 를 쓸수 있다
		 */
